...
namespace Practica3.Controllers
{
    public class SucursalsController : Controller
    {
        ...
        public SucursalsController(Editor context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IDSucursal,Nombre,Encargado,Direccion,Ciudad,Telefono,Email,Comentario")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDSucursal,Nombre,Encargado,Direccion,Ciudad,Telefono,Email,Comentario")] Sucursal sucursal)
        {
